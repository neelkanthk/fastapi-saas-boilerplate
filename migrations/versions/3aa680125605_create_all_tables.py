...
def upgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('name', sa.Enum('free', 'pro', 'enterprise', name='plan_name_enum'), server_default='free', nullable=False),
    ...
    sa.Column('status', sa.Enum('paid', 'failed', 'refunded', name='payment_status_enum'), nullable=True),
